...
Anirudh Ramesh contributed to dataset setup, preprocessing, notebook organization, model training and comparison, EfficientNet/ConvNeXt/CLIP experimentation, cleaned-data ensemble analysis, Streamlit demo integration, and final result interpretation.

Rohan Marar contributed to baseline CNN implementation, ResNet-18 transfer-learning experiments, evaluation tables and plots, confusion-matrix/error analysis, report figure preparation, and discussion of results and limitations.

Both team members reviewed notebook outputs, checked reported metrics, prepared the final report, and contributed to the presentation narrative.
